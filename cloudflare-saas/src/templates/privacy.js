/**
 * Plantilla para la página de política de privacidad
 * @param {object} data - Datos para renderizar la plantilla
 * @returns {string} - HTML de la página de política de privacidad
 */
export default function privacyTemplate(data = {}) {
  const { 
...
<body>
  ...
  <div class="privacy-content">
    ...
    <p class="last-updated">Esta política fue actualizada por última vez el ${lastUpdated}.</p>

    ${sections.map((section, index) => `
      <div id="section-${index+1}" class="privacy-section">
        <h2>${section.title}</h2>
    ...
    <div class="mt-5 text-center">
      <p class="mb-4">Si tienes alguna pregunta sobre nuestra política de privacidad, por favor contáctanos.</p>
      ...
      <div class="row">
        ...
        <div class="col-lg-2 mb-4">
          ...
          <ul class="footer-links">
            ...
            <li><a href="/politica-privacidad" class="active">Política de privacidad</a></li>
