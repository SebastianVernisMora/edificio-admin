...
class ParcialidadesManager {
  ...
  renderProgreso() {
    ...
    document.getElementById('total-objetivo')?.textContent = `$${this.progreso.objetivo_total.toLocaleString()}`;
    document.getElementById('monto-recaudado')?.textContent = `$${this.progreso.monto_recaudado.toLocaleString()}`;
    document.getElementById('porcentaje-progreso')?.textContent = `${this.progreso.porcentaje}%`;
    document.getElementById('faltante-objetivo')?.textContent = `$${this.progreso.faltante.toLocaleString()}`;
  ...
  updateEstadisticas(parcialidades) {
    ...
    document.getElementById('total-parcialidades')?.textContent = totalParcialidades;
    document.getElementById('parcialidades-validadas')?.textContent = validadas;
    document.getElementById('parcialidades-pendientes')?.textContent = pendientes;
    document.getElementById('parcialidades-rechazadas')?.textContent = rechazadas;
    document.getElementById('monto-total-parcialidades')?.textContent = `$${montoTotal.toLocaleString()}`;
  }
}
