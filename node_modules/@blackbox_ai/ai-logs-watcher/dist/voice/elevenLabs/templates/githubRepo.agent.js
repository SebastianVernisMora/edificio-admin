// src/voice/elevenLabs/templates/githubRepo.agent.ts
var githubRepoAgent = {
  "agentId": "agent_7401k5gk8ac8essrmskte5pjjyqh",
...
- Always follow the mandatory processing sequence above`,
        ...
        "maxTokens": -1,
        "toolIds": [
          "tool_6901k5hgjpfyf42v6qnfjd0ytsfm",
          "tool_6401k5gk6bmef7gv19y85pw067fv",
          "tool_4601k5gwrh5cfj9sw57vpe3v0b3q"
        ],
        "builtInTools": {},
        "mcpServerIds": [],
        "nativeMcpServerIds": [],
  ...
  "metadata": {
    "createdAtUnixSecs": 1758272433,
    "updatedAtUnixSecs": 1759227325
  },
  "platformSettings": {
    "auth": {
      "enableAuth": false,
  ...
  "workflow": {
    "edges": {
      "edge_01k5m8mct5esmtasmnzrn7dyvz": {
        "source": "start_node",
        "target": "node_01k5gk9ak4e8hr5vxbt73nbjdc",
        "forward_condition": {
          "label": null,
          "type": "unconditional"
        },
    ...
    "nodes": {
      "node_01k5gk9ak4e8hr5vxbt73nbjdc": {
        "conversation_config": {
          "asr": null,
          "turn": null,
          "tts": {
          ...
          "conversation": null,
          "language_presets": null,
          "vad": null,
          "agent": {
            "first_message": null,
            "language": null,
            "dynamic_variables": null,
            "disable_first_message_interruptions": null,
            "prompt": {
              "prompt": null,
              "llm": null,
              "reasoning_effort": null,
              ...
              "knowledge_base": null,
              "custom_llm": null,
              "ignore_default_personality": null,
              "rag": null,
              "timezone": null,
              "tools": null
            }
        ...
        "additional_prompt": "Your task is to clone a github repository from a specific url or from a user demand that you convert to url. Once the repo cloned successfully, you will receive the project structure and you can then proceed to quickly summarize what project it is, then you may answer any questions the user have for you.",
  ...
  "accessInfo": {
    "isCreator": true,
    "creatorName": "shadokan87",
    "creatorEmail": "mohamadoune.rouanet@gmail.com",
    "role": "admin"
  },
  "tags": []
};
